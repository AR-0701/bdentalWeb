...
<%
    ...
    } else if (paginaActual.contains("PrincipalAsistente.jsp") || paginaActual.contains("AgendarCllentesAsis.jsp") || paginaActual.contains("MostrarClientes.jsp") || paginaActual.contains("AgendarClientesAsis.jsp") || paginaActual.contains("mCitas.jsp") || paginaActual.contains("AsistentesPromociones.jsp") || paginaActual.contains("AsistentesServicios.jsp")) {
        accesoPermitido = "Asistente".equals(rol) || "Administrador".equals(rol);
    } else if (paginaActual.contains("PrincipaAdmin.jsp") || paginaActual.contains("mHorario.jsp") || paginaActual.contains("RegsitrarAsistentes.jsp") || paginaActual.contains("verAsistentes.jsp") || paginaActual.contains("AdmiServicio.jsp") || paginaActual.contains("AdmiPromociones.jsp")) {
